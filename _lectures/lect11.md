---
num: "Lecture 11"
desc: "String Formatting and Random Module"
...
# random() is a function that produces a random number between 0 and 1
# [0,1) -> this means including 0 but excluding 1


from random import random

y = random() # y is a number between 0 and 1

# Use random to produce a random number between 0 and 100 (not including 100)

y = random()*100

# Use random to produce a random number between 50 and 100 (not including 100) all numbers should be produced with equal probability
y = 50 + random()*50 # note that random()*50 produces numbers in the range 0 and 50
...
# choice() function that randomly selects a value from a list
# Useful for project 01
