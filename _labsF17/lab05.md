...
* <https://github.com/ucsb-cs8-f17/lab05-starter-code>
...
4.  ONE AT A TIME, copy the function definitions from the starter code, and the tests that go along with those, and get the tests to pass.
   * By one a a time, what I mean is, at your first step, copy ONLY the first function definition from  the starter code `{{page.num}}.py` and copy only the test cases from `{{page.num}}_tests.py` that go with that function definition.
